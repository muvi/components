...
procedure RoundShift1(var DstPoint: GR32.TFixedPoint; const SrcPoint: GR32.TFixedPoint; const T: TTransformation); forward; {$IFNDEF TARGET_x86}{$IFDEF INLININGSUPPORTED} inline; {$ENDIF}{$ENDIF}
procedure RoundShift2(var DstPoint: GR32.TFixedPoint; const SrcPoint: GR32.TFixedPoint; const T: TTransformation); forward; {$IFNDEF TARGET_x86}{$IFDEF INLININGSUPPORTED} inline; {$ENDIF}{$ENDIF}
procedure RoundShift4(var DstPoint: GR32.TFixedPoint; const SrcPoint: GR32.TFixedPoint; const T: TTransformation); forward; {$IFNDEF TARGET_x86}{$IFDEF INLININGSUPPORTED} inline; {$ENDIF}{$ENDIF}
procedure RoundShift8(var DstPoint: GR32.TFixedPoint; const SrcPoint: GR32.TFixedPoint; const T: TTransformation); forward; {$IFNDEF TARGET_x86}{$IFDEF INLININGSUPPORTED} inline; {$ENDIF}{$ENDIF}
procedure RoundShift16(var DstPoint: GR32.TFixedPoint; const SrcPoint: GR32.TFixedPoint; const T: TTransformation); forward; {$IFNDEF TARGET_x86}{$IFDEF INLININGSUPPORTED} inline; {$ENDIF}{$ENDIF}
procedure RoundShift32(var DstPoint: GR32.TFixedPoint; const SrcPoint: GR32.TFixedPoint; const T: TTransformation); forward; {$IFNDEF TARGET_x86}{$IFDEF INLININGSUPPORTED} inline; {$ENDIF}{$ENDIF}
...
procedure RoundShift1(var DstPoint: GR32.TFixedPoint; const SrcPoint: GR32.TFixedPoint; const T: TTransformation); {$IFNDEF TARGET_x86}{$IFDEF INLININGSUPPORTED} inline; {$ENDIF}{$ENDIF}
{.$IFNDEF TARGET_x86}
begin
