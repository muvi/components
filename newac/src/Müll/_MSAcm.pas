...
function acmMetrics(hao: HACMOBJ; uMetric: Cardinal {UINT}; var pMetric): MMRESULT; stdcall;
...
type
  ACMDRIVERENUMCB = function (hadif: HACMDRIVERID; dwInstance, fdwSupport: DWORD): LongBool {BOOL} (***); stdcall;
...
function acmDriverAddA(var phadid: HACMDRIVERID; hinstModule: Cardinal {HINST} (***); Param: LPARAM;
  dwPriority: DWORD; fdwAdd: DWORD): MMRESULT; stdcall;
{$EXTERNALSYM acmDriverAddA}
function acmDriverAddW(var phadid: HACMDRIVERID; hinstModule: Cardinal {HINST} (***); Param: LPARAM;
  dwPriority: DWORD; fdwAdd: DWORD): MMRESULT; stdcall;
{$EXTERNALSYM acmDriverAddW}
function acmDriverAdd(var phadid: HACMDRIVERID; hinstModule: Cardinal {HINST} (***); Param: LPARAM;
  dwPriority: DWORD; fdwAdd: DWORD): MMRESULT; stdcall;
...
//
type
  ACMDRIVERPROC = function (dwID: DWORD; hdrvr: HACMDRIVERID; uMsg: Cardinal {UINT} (***);
...
type
  ACMFILTERCHOOSEHOOKPROCA = function (hwd: HWND; uMsg: Cardinal {UINT} (***); wParam: WPARAM;
    lParam: LPARAM): UINT; stdcall;
  {$EXTERNALSYM ACMFILTERCHOOSEHOOKPROCA}
  ACMFILTERCHOOSEHOOKPROCW = function (hwd: HWND; uMsg: Cardinal {UINT} (***); wParam: WPARAM;
    lParam: LPARAM): UINT; stdcall;
