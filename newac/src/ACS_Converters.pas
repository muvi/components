...
(* $Id: ACS_Converters.pas 1164 2010-01-31 08:47:53Z andrei.borovsky $ *)
...
uses
  Classes, SysUtils, LCLIntf, {FastMove,} ACS_Types, ACS_Procs, ACS_Classes, _MSAcm, MMSystem, Math, LCLType;
