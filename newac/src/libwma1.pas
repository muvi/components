...
(* $Id: libwma1.pas 1164 2010-01-31 08:47:53Z andrei.borovsky $ *)
...
uses
  LCLIntf, {FastMove,} Classes, SysUtils, ActiveX, MMSystem, wmfintf, ACS_Classes, ACS_Types, ACS_Procs, SyncObjs, Windows; (***)
...
type
   ...
   public
    ...
    {function Read(pv: Pointer; cb: Longint; pcbRead: PLongint): HResult;
      stdcall;} (***)
    function Read(pv: Pointer; cb: LongWord; pcbRead: PDWord): HResult;
      stdcall;
    {function Write(pv: Pointer; cb: Longint; pcbWritten: PLongint): HResult;
      stdcall;} (***)
    function Write(pv: Pointer; cb: LongWord; pcbWritten: PDWord): HResult;
      stdcall;
...
implementation
   ...
   begin
     ...
     async_reader.CriticalSection := SyncObjs.TCriticalSection.Create;
