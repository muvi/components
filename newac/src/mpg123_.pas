...
uses
  ...
  // Modified by Andrei Borovsky

const
  Libmpg123Path = 'libmpg123.dll';
...
var
  ...
  Libmpg123Loaded : Boolean = False;

  mpg123_init: function: Longint; cdecl;

  mpg123_exit: procedure; cdecl;

  mpg123_new: function(decoder: PAnsiChar; Error: Plongint): Pmpg123_handle; cdecl;
...
var
  mpg123_plain_strerror: function(errcode: Longint): PAnsiChar; cdecl;

  mpg123_strerror: function(mh: Pmpg123_handle): PAnsiChar; cdecl;
  ...
  mpg123_decoder: function(mh: Pmpg123_handle; decoder_name: PAnsiChar): Longint; cdecl;
...
var
  ...
  mpg123_open: function(mh: Pmpg123_handle; path: PAnsiChar): Longint; cdecl;
  ...
  mpg123_set_filesize : function(mh: Pmpg123_handle; size: off_t) : Longint; cdecl;
...
var
  ...
  mpg123_add_string: function(sb: Pmpg123_string; stuff: PAnsiChar): Longint; cdecl;

  mpg123_set_string: function(sb: Pmpg123_string; stuff: PAnsiChar): Longint; cdecl;
...
var
  ...
  mpg123_icy_: function(mh: Pmpg123_handle; icy_meta: PPAnsiChar): Longint; cdecl;
...
var
  mpg123_parnew: function(mp: Pmpg123_pars; decoder: PAnsiChar; Error: Plongint): Pmpg123_handle; cdecl;
...
begin
  LoadLibCS.Enter;
  if Libmpg123Loaded then
  FreeLibrary(hlib);
  Libmpg123Loaded := False;
  LoadLibCS.Leave;
end;
...
begin
  ...
  hlib := LoadLibrary(Libmpg123Path);
  Libmpg123Loaded := hlib <> 0;
  ...
  mpg123_set_filesize := GetProcAddress(hlib, 'mpg123_set_filesize');
