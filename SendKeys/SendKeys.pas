{+--------------------------------------------------------------------------+
 | Class:       
 | Created:     12.98, Update 09/07/99 - adds adjustable delay between key presses
...
//
//
//          have fun, steveseymour@telebot.net
//          http://www.bigwig.net/softwaredesign
//          example at homepage allows multiple pop 3 accounts with netscape - wavemail.exe
